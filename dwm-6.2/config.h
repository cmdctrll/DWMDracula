...
static const char *fonts[]          = { "mono hack:size=10" , "fontawesome:size=10" };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_equal,  spawn,	   SHCMD("pamixer --allow-boost -i 10; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_minus,  spawn,	   SHCMD("pamixer --allow-boost -d 10; kill -44 $(pidof dwmblocks)") },
